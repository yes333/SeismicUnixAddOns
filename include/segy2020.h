...
typedef struct {	/* segy - trace identification header */
	...
	short mark;	/* mark selected traces
        ...
        /* RWS local assignments */
        float dx;	/* place holder for floating point
        		   byte# 213-216
        		*/

        float fx;	/* place holder for floating point
        		   byte# 217-220
        		*/

        float dy;	/* place holder for floating point
        		   byte# 221-224
        		*/

        float fy;	/* place holder for floating point
        		   byte# 225-228
        		*/

        float dz;	/* place holder for floating point 
        		   byte# 229-232
        		*/

        float fz;	/* place holder for floating point
        		   byte# 233-236
        		*/

        short unass[2];	/* unassigned--NOTE: last entry causes
...
typedef struct {	/* bhed - binary header */
	...
	//YES extension of binary header words

	short ncomp;	// number of geophone components per file:

	short nmode;	// number of wave modes per trace

	short vsp;		// VSP flag

	short idelay;	// instrument delay in microsecond

	int   offset;	// shot-hydrophone offset in meters 


	short hunass[164];      /* unassigned */
