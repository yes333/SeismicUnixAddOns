...
typedef struct {        /* bhedtape - binary header */
    ...
    unsigned int  ncomp:16;	/* number of geophone components per file: */

    unsigned int  nmode:16;	/* number of wave modes per trace */

    unsigned int  vsp:16;	/* VSP flag */

    unsigned int  idelay:16;	/* instrument delay in microsecond */

    unsigned int  offset:32;	/* shot-hydrophone offset in meters */

        unsigned char hunass[328];      /* unassigned */
